...
import ListPlaceCard from '../../components/list-place-cards/list-place-cards';
...
function MainScreen({ sum, offers }: MainScreenProp): JSX.Element {
  return (
        ...
        <div className='cities'>
          <div className='cities__places-container container'>
            <section className='cities__places places'>
              ...
              <b className='places__found'>{sum} places to stay in Amsterdam</b>
